...
(deftest can-parse
  (testing "parse-entry can parse an standard entry to generate Percolator Actions"
    (let [result (gnip/parse-entry input)
...
(deftest tweet-id-from-url
  (testing "tweet-id-from-url can extract the tweet ID from a tweet ID url"
    (is (= 
          "1111111111"
          (gnip/tweet-id-from-url "http://twitter.com/2222222222/statuses/1111111111")))))
